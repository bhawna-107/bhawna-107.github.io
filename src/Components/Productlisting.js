...
const Productlisting = () => {
  return (
    <div id="product" className='h-[774px] w-full lg:px-[90px] px-[19px] py-[70px]'>
      <div className='flex flex-row justify-between items-center'>
        <p className='lg:text-[90px] text-[40px] font-semibold leading-[55px] px-[15px]'>New products</p>
        <div className='flex flex-row gap-2'>
           <img className='w-10 h-3 ' src={arrow1} alt=''/>
           <img className='w-10 h-3' src={arrow2} alt='' />
        </div>
      </div>
      <img className='sm:w-[48%] w-full mt-3' src={starline} alt='' />

      <div className='flex sm:flex-row flex-col gap-20 mt-3 '>
        ...
        <div className='lg:w-[300px] w-[100%] h-full  relative'>
              ...
              <p className="  text-neutral-900 text-opacity-50 text-sm font-normal">
